...
import co.edu.udistrital.espingsw.huellitaspelitos.databinding.ActivityEndServicesBinding
...
class EndServicesActivity : AppCompatActivity() {

    private lateinit var _binding: ActivityEndServicesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _binding = ActivityEndServicesBinding.inflate(layoutInflater)
